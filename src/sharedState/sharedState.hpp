...
public:
    ...
    virtual async::ManualTask<std::pair<Result, uint32_t>> getFriendsRegisteredClientCount() = 0;
    ...
    virtual async::ManualTask<std::pair<Result, uint32_t>> getSplatoonRegisteredClientCount() = 0;
    ...
    virtual async::ManualTask<std::pair<Result, uint32_t>> getSplatoonMatchmakeSessionCount() = 0;
