...
#define REDIS_SCAN_COUNT_CHUNK_SIZE 1000
...
private:
    ...
    std::map<uint32_t, nex::rmc::FriendsRegisteredClientInfo> localFriendsClientCache;
    std::mutex localFriendsClientCacheMutex;
