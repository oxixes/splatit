#ifndef SPLATOON_SERVER_INTERNALACCOUNTMANAGEMENTSERVICE_HPP
#define SPLATOON_SERVER_INTERNALACCOUNTMANAGEMENTSERVICE_HPP
...
#endif //SPLATOON_SERVER_INTERNALACCOUNTMANAGEMENTSERVICE_HPP